...
void KreditsMQ::rebuild_pollitems() {
    pollitems.clear();
...
void KreditsMQ::setup_external_socket(zmq::socket_t& socket) {
...
void KreditsMQ::setup_outgoing_socket(zmq::socket_t& socket, string_view remote_pubkey) {
...
ConnectionID KreditsMQ::connect_sn(string_view pubkey, std::chrono::milliseconds keep_alive, string_view hint) {
...
ConnectionID KreditsMQ::connect_remote(string_view remote, ConnectSuccess on_connect, ConnectFailure on_failure,
...
void KreditsMQ::disconnect(ConnectionID id, std::chrono::milliseconds linger) {
...
KreditsMQ::proxy_connect_sn(string_view remote, string_view connect_hint, bool optional, bool incoming_only, bool outgoing_only, std::chrono::milliseconds keep_alive) {
...
std::pair<zmq::socket_t *, std::string> KreditsMQ::proxy_connect_sn(bt_dict_consumer data) {
...
void KreditsMQ::proxy_close_connection(size_t index, std::chrono::milliseconds linger) {
...
void KreditsMQ::proxy_expire_idle_peers() {
...
void KreditsMQ::proxy_conn_cleanup() {
...
void KreditsMQ::proxy_connect_remote(bt_dict_consumer data) {
...
void KreditsMQ::proxy_disconnect(bt_dict_consumer data) {
...
void KreditsMQ::proxy_disconnect(ConnectionID conn, std::chrono::milliseconds linger) {
